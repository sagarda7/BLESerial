...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED =
            "np.com.sagardevkota.lairdble.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =
            "np.com.sagardevkota.lairdble.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED =
            "np.com.sagardevkota.lairdble.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE =
            "np.com.sagardevkota.lairdble.ACTION_DATA_AVAILABLE";

    public final static String ACTION_DATA_AVAILABLE_NOTIFICATION =
            "np.com.sagardevkota.lairdble.ACTION_DATA_AVAILABLE_NOTIFICATION";
    public final static String EXTRA_DATA =
            "np.com.sagardevkota.lairdble.EXTRA_DATA";


    private UUID mReceiveUUID,mSendUUID, mServiceUUID, mDataAvailableUUID;

    public void setDataAvailableUUID(UUID mDataAvailableUUID) {
        this.mDataAvailableUUID = mDataAvailableUUID;
    }

    public void setReceiveUUID(UUID mReceiveUUID) {
    ...
    public void setSendUUID(UUID mSendUUID) {
        ...
        public void onCharacteristicRead(BluetoothGatt gatt,
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                if (mServiceUUID.equals(serviceUUID))
                {
                    ...
                    if (mReceiveUUID.equals(charUUID))
                    {
